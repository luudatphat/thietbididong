...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<ul class="nav menu">
			...
			<li class="active"><a href="{{route('adindex')}}"><svg class="glyph stroked dashboard-dial"><use xlink:href="#stroked-dashboard-dial"></use></svg> Trang chủ</a></li>
			<li><a href="{{route('adproduct')}}"><svg class="glyph stroked calendar"><use xlink:href="#stroked-calendar"></use></svg> Sản phẩm</a></li>
			<li class="active"><a href="{{route('adcategory')}}"><svg class="glyph stroked notepad "><use xlink:href="#stroked-notepad"/></svg> Danh mục</a></li>
		...
		<div class="row">
			...
			<div class="col-xs-12 col-md-5 col-lg-5">
					<div class="panel panel-primary">
						...
						<form  action="{{route('adcategory')}}" method="post" >
				<input type="hidden" name="_token" value="{{ csrf_token() }}">
						<div class="panel-body">
								...
								@endif
								@if(Session::has('thanhcongcong'))
								<div class="alert alert-success">
									 {{Session::get('thanhcongcong')}}
								</div>
								@endif
							<div class="form-group">
								<label>Tên danh mục:</label>
    							<input type="text" name="name" class="form-control" placeholder="Tên danh mục...">
    							<button type="submit" class="btn btn-black"> Thêm</button>
							</div>
						</div>
				</form>
					</div>
								...
								@endif
				              	...
				              	<tbody>
				              		<tr>
				              			...
				              			<td>{{$value->TenLoai}}</td>
				              			<td>
			                    		<a href="{!! url('adeditcategory',[$value->idLoai]) !!}" class="btn btn-warning"><span class="glyphicon glyphicon-edit"></span> Sửa</a>
			                    		<a href="{{route('addeletecategory',[$value->idLoai])}}"  onclick="return confirm('Bạn có chắc chắn muốn xóa?')" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Xóa</a>
			                  		</td>
