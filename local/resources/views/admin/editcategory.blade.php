		...
		<div class="row">
			<div class="col-xs-12 col-md-5 col-lg-5">
					<div class="panel panel-primary">
						...
						<form action="{{route('adeditcategory',[$value->idLoai])}}" method="post" class="form-horizontal" role="form">
						...
						<div class="panel-body">
							<div class="form-group">
								<label>ID</label>
    							<input type="text" name="idloai" class="form-control"value="{{ $value->idLoai }}" disabled="">
							</div>
							<div class="form-group">
								<label>Tên danh mục:</label>
    							<input type="text" name="TenLoai" class="form-control"value="{{ $value->TenLoai }}">
							</div>
							<div class="form-group">
