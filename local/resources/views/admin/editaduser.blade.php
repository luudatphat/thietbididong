			...
			<div class="col-xs-12 col-md-12 col-lg-12">
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						...
						<form action="{{route('changeaduser',[$value->id])}}" method="post" class="form-horizontal" role="form">
						...
						<div class="row" style="margin-bottom:40px">
								<div class="col-xs-8">
									...
									<div class="form-group" >
										<label>Email </label>
										<input required type="text" name="price" class="form-control" value="{{ $data['email'] }}" disabled="" >
									</div>
									<div class="form-group" >
										<label>Phone</label>
										<input required type="text" name="name" class="form-control" value="{{ $data['phone'] }}">
					                   
									</div>
									<div class="form-group" >
										<label>Địa chỉ</label>
										<input required type="text" name="accessories" class="form-control" value="{{ $data['diachi'] }} ">
									</div>
